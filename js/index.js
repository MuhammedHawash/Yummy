...
function closeSideNav() {
  let newWidth = $(".hidden-nav").outerWidth(true);
  $(".left-nav").animate({left:-newWidth}, 500);
  $(".open-close-icon").removeClass("fa-x").addClass("fa-align-justify");
  $(".links li").animate({top: 300}, 500);
}

closeSideNav()
$(".left-nav .shown-nav i").click(() => {
...
function showSearchInputs() {
  ...
  <div class="row py-4 ">
      ...
      <div class="col-md-6">
          <input onkeyup="searchByFilter(this.value)" maxlength="1" class="form-control bg-white  text-black" type="text" placeholder="Search By First Letter">
      </div>
  </div>`
